...
const LoadingIcon = <svg className="animate-spin size-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
  ...
  ({ className, variant, size, asChild = false, loading, children, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        {...props}
      >
        <span className={cn(loading ? "opacity-0" : "inline-flex items-center justify-center", className)}>
          {children}
        </span>
